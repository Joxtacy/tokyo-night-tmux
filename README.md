...
In your `tmux.conf`:
```
set -g @plugin "Joxtacy/tokyo-night-tmux"
set -g @tokyonight-show-git-status "on" # Show git status in the status bar. Leave out or set to empty string to have it not show.
```
